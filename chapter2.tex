...
\chapter{Related Work on Provenance Collection Systems}\label{background}
...
\section{Compressing Provenance Graphs}

\textcolor{red}{Xie et al proposed a compression technique which is an extension of web compression.}
